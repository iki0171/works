                    ...
                    <div id="section" class="section">
						...
						<div class="sub_menu">
						    <ul>
						        <li>
						        	<i class="i_icon04"></i>
						        	<p class="title">등록면허세(등록분)</p>
						            <a href="" onclick="executeCMD('LPEPBF0R0'); return false;" class="btn_type07">신고</a>
								</li>
								<li>
									<i class="i_icon05"></i>
									<p class="title">등록면허세(면허분)</p>
								    <a href="" onclick="executeCMD('LPEPBG0R0'); return false;" class="btn_type07">한 건 신고</a>
								    <a href="" onclick="executeCMD('LPEPBG7F0'); return false;" class="btn_type07">일괄 신고</a>
								</li>
						        <li>
									<i class="i_icon_last"></i>
									<p class="title">등록면허세 납부</p>
