                    ...
                    <div id="section" class="section">
						...
						<div class="sub_menu">
						    <ul>
						        <li>
						        	<i class="i_icon01"></i>
						        	<p class="title">유상취득(농지 외) <em class="color3">신고필증일련번호</em></p>
						            <a href="" onclick="executeCMD('LPEPBL4R0'); return false;" class="btn_type07">신고</a>
								</li>
								<li>
									<i class="i_icon02"></i>
									<p class="title">상속,증여,기부,경락(주택)</p>
								    <a href="" onclick="executeCMD('LPEPBL6R0'); return false;" class="btn_type07">신고</a>
								</li>
								<li>
									<i class="i_icon03"></i>
									<p class="title">상속,증여,기부,경락(토지/건물)</p>
				                    <a href="" onclick="executeCMD('LPEPBL8R0'); return false;" class="btn_type07">신고</a>
						        </li>
						        <li>
									<i class="i_icon_last"></i>
									<p class="title">취득세 납부</p>
						...
						<div class="text_info mar_b40">
							<h3>이용안내</h3>
						    <div class="comment">
						        <p>부동산(취득세) 신고에 대한 안내</p>
						        <ul>
									<li>부동산 취득 유형이 <em class="color3">유상취득(농지 외)</em>이고, <em class="color3">신고필증일련번호</em>가 있는 경우.</li>
									<li>부동산 취득 유형이 <em class="color3">상속, 증여, 기부, 경락(주택)</em>에 해당하는 경우.</li>
									<li>부동산 취득 유형이 <em class="color3">상속, 증여, 기부, 경락(토지/건물)</em>에 해당하는 경우.</li>
				                </ul>
				                <span class="txt1">※ 상기 이외의 물건 및 취득유형에 관한 취득세 신고는 방문신고 하시기 바랍니다.</span>
				            </div>
				        </div>
				        <!--// 이용안내 -->
