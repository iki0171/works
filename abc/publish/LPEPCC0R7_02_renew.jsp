			...
			<div class="gnb_wrap">
                <div class="gnb">
                    ...
                    <ul>
                        ...
                        <li class="s_3">
                            <a href="" class="ok" onclick=""><span>환급신청</span></a>
                            <div class="gnb_box" style="display: none;">
                            </div>
                        </li>
                        <li class="s_4">
            ...
            <div class="inner">
                <div class="location" id="new_con">
                    <ol>
                        ...
                        <li>
                            <button type="button" class="location_btn"><em>환급신청</em></button>
                            <ul class="menu_find"></ul>
                        </li>
                        <li>
                            <button type="button" class="location_btn"><em>환급금 간단 조회</em></button>
                            <ul class="menu_find"></ul>
                        </li>
                    </ol>
                </div>
                ...
                <div class="inner">
                    ...
                    <div class="tab_box">
                        <ul class="list ea2">
                            ...
                            <li class="on"><a href="">환급금 통합 조회</a></li>
                        </ul>
                    </div>
                    <!--// tab -->
                    ...
                    <div id="section" class="section">
						...
						<div class="preservation">
							<i class="img_com"></i>
							<p>환급금 통합조회</p>
							<span>국세, 지방세, 보관금/송달료, 건강보험 미환급금, 유료방송 미환급금 등의 <br/>과오납으로 인한 환급액을 <strong>일괄로 확인하고 통합 신청</strong> 할 수 있는 서비스입니다.</span>
							<div class="btn_type">
								<a class="btn_type02" href="http://www.minwon.go.kr/etc/AA090_pkg_srch_refund.jsp" target="_blank" title="새창" style="width: 220px;">환급금 통합조회 바로가기</a>
							</div>
						</div>
						<!--// 환급금 통합조회 -->
                        ...
                        <div class="guide_info">
                            ...
                            <div class="comment">
                                <ul>
                                    <li>이용 문의는 행정정보공동이용센터(1600-8200)에서 가능합니다.</li>
                                    <li>문의 가능 시간은 월~금, 09:00~18:00입니다.</li>
                                </ul>
                            </div>
                        </div>
                        <!-- 이용안내 -->
