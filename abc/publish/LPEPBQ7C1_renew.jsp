            ...
            <div class="inner">
                <div class="location" id="new_con">
                    <ol>
                        ...
                        <li>
                            <button type="button" class="location_btn"><em>법인소득분</em></button>
                            <ul class="menu_find"></ul>
                        </li>
                    </ol>
                </div>
            ...
            <div class="contents">
                <div class="inner">
                    ...
                    <div id="section" class="section">
                    	<div class="guid_finish up_result">
                        	<i class="img_com"></i>
                            <p><em class="color5">일괄신고서 등록에 오류가 발생하였습니다.</em></p>
                            <span class="txt1">확인 버튼을 선택하시면 일괄신고서를 재등록 할 수 있는 화면으로 이동합니다.</span>
                            <span class="txt2">확인 버튼을 선택하시면 일괄신고서를 재등록 할 수 있는 화면으로 이동합니다.</span>
                        </div>
                        <!-- 일괄신고서 검증결과 -->
                                        ...
                                        <div class="table_col mar_b0">
                                            <table>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td>1</td>
														<td class="text_l">개인/법인 구분코드는 필수 입력 항목입니다.</td>
                                                    </tr>
                                                    <tr>
                                                        <td>2</td>
														<td class="text_l">시도코드는 필수 입력 항목입니다.</td>
                                                    </tr>
                                                    <tr>
                                                        <td>4</td>
														<td class="text_l">신고종류코드는 필수 입력 항목입니다.</td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </div>
                        ...
                        <div class="btn_wrap">
                            <ul>
                                <li class="float_r">
                                	<a href="#n" class="btn_type01 bg3" onclick="" title="확인">확인</a>
