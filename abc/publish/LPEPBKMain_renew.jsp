            ...
            <div class="inner">
                <div class="location" id="new_con">
                    <ol>
                        ...
                        <li>
                            <button type="button" class="location_btn"><em>레저세</em></button>
                            <ul class="menu_find"></ul>
                        </li>
                    </ol>
                </div>
                    ...
                    <div id="section" class="section">
						...
						<div class="sub_menu">
						    <ul>
								<li>
									<i class="i_icon14"></i>
									<p class="title">레저세 신고</p>
								    <a href="" onclick="executeCMD('LPEPBK0R0'); return false;" class="btn_type07">한 건 신고</a>
								    <a href="" onclick="executeCMD('LPEPBK7F0'); return false;" class="btn_type07">일괄 신고</a>
								</li>
						        <li>
									<i class="i_icon_last"></i>
									<p class="title">레저세 납부</p>
