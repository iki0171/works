                    ...
                    <div id="section" class="section">
						...
						<div class="sub_menu">
						    <ul>
						        <li>
						        	<i class="i_icon17"></i>
						        	<p class="title">담배반출신고</p>
						            <a href="" onclick="" class="btn_type07">한 건 신고</a>
						            <a href="" onclick="" class="btn_type07">일괄 신고</a>
						            <a href="" onclick="" class="btn_type07">담배반출 신고내역 조회</a>
						            <a href="" onclick="" class="btn_type07">담배반출 일괄내역 조회</a>
								</li>
								<li>
									<i class="i_icon18"></i>
									<p class="title">면세담배공급신고</p>
								    <a href="" onclick="" class="btn_type07">한 건 신고</a>
								    <a href="" onclick="" class="btn_type07">일괄 신고</a>
								    <a href="" onclick="" class="btn_type07">담배반출 신고내역 조회</a>
						            <a href="" onclick="" class="btn_type07">담배반출 일괄내역 조회</a>
								...
								<li>
						        	<i class="i_icon20"></i>
						        	<p class="title">수입판매자</p>
						            <a href="" onclick="" class="btn_type07">신고</a>
								</li>
								<li>
						        	<i class="i_icon21"></i>
						        	<p class="title">반출전신고납부</p>
						            <a href="" onclick="" class="btn_type07">신고</a>
								</li>
								<li>
						        	<i class="i_icon22"></i>
						        	<p class="title">납세담보확인 발급신청</p>
						            <a href="" onclick="" class="btn_type07">신고</a>
								</li>
								<li>
						        	<i class="i_icon23"></i>
						        	<p class="title">담배소비세 환급신청</p>
						            <a href="" onclick="" class="btn_type07">환급신청</a>
						            <a href="" onclick="" class="btn_type07">신청내역 조회</a>
								</li>
						        <li>
									<i class="i_icon_last"></i>
									<p class="title">담배소비세 납부</p>
