                    ...
                    <div id="section" class="section">
						...
						<div class="sub_menu">
						    <ul>
						        <li>
						        	<i class="i_icon06"></i>
						        	<p class="title">종업원분</p>
						            <a href="" onclick="executeCMD('LPEPBR0R0'); return false;" class="btn_type07">한 건 신고</a>
						            <a href="" onclick="executeCMD('LPEPBR7F0'); return false;" class="btn_type07">일괄 신고</a>
								</li>
								<li>
									<i class="i_icon07"></i>
									<p class="title">재산분</p>
								    <a href="" onclick="executeCMD('LPEPBS0R0'); return false;" class="btn_type07">한 건 신고</a>
								    <a href="" onclick="executeCMD('LPEPBS7F0'); return false;" class="btn_type07">일괄 신고</a>
								</li>
								<li>
						        	<i class="i_icon08"></i>
						        	<p class="title">건물사용명세서</p>
						            <a href="" onclick="executeCMD('LPEPBS5R0'); return false;" class="btn_type07">신고</a>
								</li>
						        <li>
									<i class="i_icon_last"></i>
									<p class="title">주민세 납부</p>
