                ...
                <div class="inner">
                    ...
                    <div class="step">
                        <ul class="list">
                            ...
                            <li class="on"><span>작성확인 및 신고</span></li>
                    ...
                    <div id="section" class="section">
                                        ...
                                        <table>
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td colspan="3">
                                                        <input type="text" id="fileName0" name="fileName0" title="파일" value="등록가액 증빙서류.jpg" maxlength="80" readonly="readonly" />
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
                        ...
                        <div class="btn_wrap">
                            <ul>
                                <li class="float_r">
                                    <a href="#n" id="" class="btn_type01 bg4" title="확인">수정</a>
                                    <a href="#n" id="" class="btn_type01 bg1" title="확인">확인</a>
                                </li>
                            </ul>
                        </div>
                        <!--// 버튼 -->
