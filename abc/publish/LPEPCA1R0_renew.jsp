                ...
                <div class="inner">
                    ...
                    <div id="section" class="section">
                        ...
                        <div class="content_box">
                            <div class="title">
                                <h3>자동차세(자동차)<span><strong>미납</strong>내역입니다.</span></h3>
                            </div>
                            <div class="cont_body">
                                <div class="board">
                                    <div class="table_row details">
                                        <table>
                                            <caption>조회납부 상세</caption>
                                            <colgroup>
                                                <col style="width:14%">
                                                <col style="width:34%">
                                                <col style="width:18%">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td><span>26470-1-30-20-1-0011680-5</span></td>
                                                    <th scope="row">납세번호</th>
                                                    <td><span>110-5-30-110000-202004-3-250-000008-4 </span></td>
                                                </tr>
                                                <tr>
                                                    <th scope="row">세목</th>
                                                    <td><span>자동차세(자동차) (106001)</span></td>
                                                    <th scope="row"></th>
                                                    <td></td>
                                                </tr>
                                                <tr>
                                                    <th scope="row">과세대상</th>
                                                    <td colspan="3"><span>10루5526(비영업용, 배기량:1998) [차량경감율:50%] [과세기간(2020.01.01~2020.12.31)]</span></td>
                                                </tr>
                                                <tr>
                                                    <th scope="row">청구시도</th>
                                                    <td><span>부산광역시 (26)</span></td>
                                                    <th scope="row">기관</th>
                                                    <td><span>연제구 (470)</span></td>
                                                </tr>
                                                <tr>
                                                    <th scope="row">납세자</th>
                                                    <td><span>이대로</span></td>
                                                    <th scope="row">납세연월</th>
                                                    <td><span>2020년 01월</span></td>
                                                </tr>
                                                <tr>
                                        ...
                                        <table>
                                            ...
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th scope="col">부과내역(과세표준)</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <tr>
                                                    <th scope="row">본세</th>
                                                    <td class="text_r">30,540 원</td>
                                                    <td class="text_r">5,090,000 원</td>
                                                </tr>
                                                <tr>
                                                    <th scope="row">지역자원시설세/농특세</th>
                        ...
                        <div class="btn_wrap">
                            <ul>
                                <li class="float_l">
                                    ...
                                    <a href="#n" id="" class="btn_type02" title="가상계좌조회">가상계좌조회</a>
                                </li>
                                <li class="float_r">
