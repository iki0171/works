                    ...
                    <div id="section" class="section">
						...
						<div class="sub_menu">
						    <ul>
						        <li>
						        	<i class="i_icon06"></i>
						        	<p class="title">종합소득</p>
						            <a href="" onclick="executeCMD('LPEPBZ0R0'); return false;" class="btn_type07">일반신고</a>
						            <a href="" onclick="executeCMD('LPEPBZ3R0'); return false;" class="btn_type07">토지 등 매매차익 예정신고</a>
						            <a href="" onclick="executeCMD('LPEPBZ7R8'); return false;" class="btn_type07">신고센터조회</a>
						            <a href="" onclick="executeCMD('LPEPBZ8R9'); return false;" class="btn_type07">신고유형 조회</a>
								</li>
								<li>
									<i class="i_icon07"></i>
									<p class="title">양도소득</p>
								    <a href="" onclick="executeCMD('LPEPBI0R0'); return false;" class="btn_type07">한 건 신고</a>
								    <a href="" onclick="executeCMD('LPEPBI7F0'); return false;" class="btn_type07">일괄 신고</a>
								</li>
								<li>
						        	<i class="i_icon08"></i>
						        	<p class="title">특별징수</p>
						            <a href="" onclick="executeCMD('LPEPGAMain'); return false;" class="btn_type07">신고</a>
								</li>
								<li>
						        	<i class="i_icon08"></i>
						        	<p class="title">법인소득</p>
						            <a href="" onclick="executeCMD('LPEPGDMain'); return false;" class="btn_type07">신고</a>
								</li>
						        <li>
									<i class="i_icon_last"></i>
									<p class="title">지방소득세 납부</p>
						...
						<div class="text_info mar_b40">
							...
							<!-- tab1 -->
							<div id="tab1" class="comment tab_con">
								<p>종합소득에 대한 개인지방소득세 신고 안내</p>
								<strong>일반신고</strong>
								<ul>
									<li>사업소득, 근로소득, 연금소득 등의 소득이 있는 소득자가 작성하며, 일반납세자의 경우 5월 1일부터 5월 31일까지 신고하여야 합니다. (성실신고확인대상자는 6월까지 신고)</li>
								</ul>
								<strong>토지 등 매매차익 예정신고</strong>
								<ul>
									<li>부동산매매업자가 토지 또는 건물의 매매차익(매매차손)을 신고할 때 작성하며, 매매일이 속하는 달의 말일부터 2개월이 되는 날까지 신고하여야 합니다.</li>
								</ul>
							</div>
							<!--// tab1 -->
											            
							<!-- tab2 -->
							<div id="tab2" class="comment tab_con">
								<p>2양도소득 신고에 대한 안내</p>
								<ul>
									<li>안내1</li>
									<li>안내2</li>
							...
							<!-- tab3 -->
							<div id="tab3" class="comment tab_con">
								<p>3특별징수 신고에 대한 안내</p>
								<ul>
									<li>안내1</li>
									<li>안내2</li>
							...
							<!-- tab4 -->
							<div id="tab4" class="comment tab_con">
								<p>4법인소득 신고에 대한 안내</p>
								<ul>
									<li>안내1</li>
									<li>안내2</li>
