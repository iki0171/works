            ...
            <div class="inner">
                <div class="location" id="new_con">
                    <ol>
                        ...
                        <li>
                            <button type="button" class="location_btn"><em>지역자원시설세</em></button>
                            <ul class="menu_find"></ul>
                        </li>
                    </ol>
                </div>
                    ...
                    <div id="section" class="section">
						...
						<div class="sub_menu">
						    <ul>
								<li>
									<i class="i_icon13"></i>
									<p class="title">지역자원시설세 신고</p>
								    <a href="" onclick="executeCMD('LPEPBH0R0'); return false;" class="btn_type07">한 건 신고</a>
								    <a href="" onclick="executeCMD('LPEPBJ7F0'); return false;" class="btn_type07">일괄 신고</a>
								</li>
						        <li>
									<i class="i_icon_last"></i>
									<p class="title">지역자원시설세 납부</p>
